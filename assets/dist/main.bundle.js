...
function ServiceWorkerHandler_classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function ServiceWorkerHandler_defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, ServiceWorkerHandler_toPropertyKey(o.key), o); } }
function ServiceWorkerHandler_createClass(e, r, t) { return r && ServiceWorkerHandler_defineProperties(e.prototype, r), t && ServiceWorkerHandler_defineProperties(e, t), Object.defineProperty(e, "prototype", { writable: !1 }), e; }
function ServiceWorkerHandler_toPropertyKey(t) { var i = ServiceWorkerHandler_toPrimitive(t, "string"); return "symbol" == ServiceWorkerHandler_typeof(i) ? i : i + ""; }
function ServiceWorkerHandler_toPrimitive(t, r) { if ("object" != ServiceWorkerHandler_typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != ServiceWorkerHandler_typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }

var ServiceWorkerHandler = /*#__PURE__*/function () {
  function ServiceWorkerHandler() {
    ServiceWorkerHandler_classCallCheck(this, ServiceWorkerHandler);
  }
  return ServiceWorkerHandler_createClass(ServiceWorkerHandler, null, [{
    key: "init",
    value: function init() {
      if ('serviceWorker' in navigator) {
        this.registerServiceWorker();
    ...
    key: "registerServiceWorker",
    value: function registerServiceWorker() {
      var serviceWorkerPath = SAGUTID_CONFIG.serviceWorkerPath;
      ...
      navigator.serviceWorker.register(serviceWorkerPath).then(function (reg) {
        Logger.log("Service worker registered at: ".concat(reg.scope), 'green', 'ServiceWorkerHandler');
      })["catch"](function (err) {
        Logger.error("Service worker registration failed: ".concat(err), 'ServiceWorkerHandler');
      });
    }
  }, {
    key: "listenForUpdate",
...
function __importStar(mod) {
  ...
  var result = {};
  if (mod != null) for (var k = tslib_es6_ownKeys(mod), i = 0; i < k.length; i++) if (k[i] !== "default") __createBinding(result, mod, k[i]);
 ...
 */
class Elevation extends lit_element_i {
    connectedCallback() {
 ...
 */
class FocusRing extends lit_element_i {
    constructor() {
        super(...arguments);
        /**
 ...
 * A ripple component.
 */
class Ripple extends lit_element_i {
    constructor() {
        super(...arguments);
        /**
         * Disables the ripple.
...
const buttonBaseClass = mixinDelegatesAria(mixinElementInternals(lit_element_i));
/**
 * A button component.
 */
...
__decorate([
    property_n({ type: Boolean, attribute: 'soft-disabled', reflect: true })
...
const shared_elevation_styles_styles = i `md-elevation{transition-duration:280ms}:host(:is([disabled],[soft-disabled])) md-elevation{transition:none}md-elevation{--md-elevation-level: var(--_container-elevation);--md-elevation-shadow-color: var(--_container-shadow-color)}:host(:focus-within) md-elevation{--md-elevation-level: var(--_focus-container-elevation)}:host(:hover) md-elevation{--md-elevation-level: var(--_hover-container-elevation)}:host(:active) md-elevation{--md-elevation-level: var(--_pressed-container-elevation)}:host(:is([disabled],[soft-disabled])) md-elevation{--md-elevation-level: var(--_disabled-container-elevation)}
`;
...
// Separate variable needed for closure.
const checkboxBaseClass = mixinDelegatesAria(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(lit_element_i))));
/**
...
Checkbox.shadowRootOptions = {
    ...lit_element_i.shadowRootOptions,
    delegatesFocus: true,
};
__decorate([
...
// Separate variable needed for closure.
const chipBaseClass = mixinDelegatesAria(lit_element_i);
/**
 * A chip component.
 *
 ...
 */
class ChipSet extends lit_element_i {
    get chips() {
 ...
 * A divider component.
 */
class Divider extends lit_element_i {
    constructor() {
        super(...arguments);
        /**
...
// Separate variable needed for closure.
const dialogBaseClass = mixinDelegatesAria(lit_element_i);
/**
 * A dialog component.
 *
...
__decorate([
    property_n({ type: Boolean, attribute: 'no-focus-trap' })
...
// Separate variable needed for closure.
const fabBaseClass = mixinDelegatesAria(lit_element_i);
...
MdBrandedFab.styles = [
    fab_internal_shared_styles_styles,
    fab_branded_styles_styles,
    forced_colors_styles_styles,
];
 ...
 * A field component.
 */
class Field extends lit_element_i {
    constructor() {
        super(...arguments);
        this.disabled = false;
        this.error = false;
...
__decorate([
    property_n({ type: Boolean, attribute: 'no-asterisk' })
 ...
 */
class Icon extends lit_element_i {
    render() {
        return x `<slot></slot>`;
    }
    connectedCallback() {
...
// Separate variable needed for closure.
const iconButtonBaseClass = mixinDelegatesAria(mixinElementInternals(lit_element_i));
/**
...
class IconButton extends iconButtonBaseClass {
    ...
    render() {
        const tag = this.href ? static_i `div` : static_i `button`;
        // Needed for closure conformance
        const { ariaLabel, ariaHasPopup, ariaExpanded } = this;
...
const iconbutton_internal_shared_styles_styles = i `:host{display:inline-flex;outline:none;-webkit-tap-highlight-color:rgba(0,0,0,0);height:var(--_container-height);width:var(--_container-width);justify-content:center}:host([touch-target=wrapper]){margin:max(0px,(48px - var(--_container-height))/2) max(0px,(48px - var(--_container-width))/2)}md-focus-ring{--md-focus-ring-shape-start-start: var(--_container-shape-start-start);--md-focus-ring-shape-start-end: var(--_container-shape-start-end);--md-focus-ring-shape-end-end: var(--_container-shape-end-end);--md-focus-ring-shape-end-start: var(--_container-shape-end-start)}:host(:is([disabled],[soft-disabled])){pointer-events:none}.icon-button{place-items:center;background:none;border:none;box-sizing:border-box;cursor:pointer;display:flex;place-content:center;outline:none;padding:0;position:relative;text-decoration:none;user-select:none;z-index:0;flex:1;border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}.icon ::slotted(*){font-size:var(--_icon-size);height:var(--_icon-size);width:var(--_icon-size);font-weight:inherit}md-ripple{z-index:-1;border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}.flip-icon .icon{transform:scaleX(-1)}.icon{display:inline-flex}.link{display:grid;height:100%;outline:none;place-items:center;position:absolute;width:100%}.touch{position:absolute;height:max(48px,100%);width:max(48px,100%)}:host([touch-target=none]) .touch{display:none}@media(forced-colors: active){:host(:is([disabled],[soft-disabled])){--_disabled-icon-color: GrayText;--_disabled-icon-opacity: 1}}
`;
//# sourceMappingURL=shared-styles.js.map
...
// tslint:disable-next-line:enforce-comments-on-exported-symbols
class List extends lit_element_i {
    /** @export */
    get items() {
 ...
 */
class Item extends lit_element_i {
    constructor() {
        super(...arguments);
        /**
         * Only needed for SSR.
...
// Separate variable needed for closure.
const listItemBaseClass = mixinDelegatesAria(lit_element_i);
/**
 ...
 */
class Menu extends lit_element_i {
    /**
...
__decorate([
    property_n({ type: Boolean, attribute: 'no-horizontal-flip' })
], Menu.prototype, "noHorizontalFlip", void 0);
__decorate([
    property_n({ type: Boolean, attribute: 'no-vertical-flip' })
...
// Separate variable needed for closure.
const menuItemBaseClass = mixinDelegatesAria(lit_element_i);
/**
 ...
 */
class SubMenu extends lit_element_i {
    get item() {
...
// Separate variable needed for closure.
const progressBaseClass = mixinDelegatesAria(lit_element_i);
/**
 ...
 * focused.
 */
const focusable_isFocusable = Symbol('isFocusable');
...
function mixinFocusable(base) {
    ...
    class FocusableElement extends base {
        ...
        get [focusable_isFocusable]() {
            return this[privateIsFocusable];
        }
        set [focusable_isFocusable](value) {
            if (this[focusable_isFocusable] === value) {
                return;
            }
        ...
        [(_a = privateIsFocusable, _b = externalTabIndex, _c = isUpdatingTabIndex, updateTabIndex)]() {
            const internalTabIndex = this[focusable_isFocusable] ? 0 : -1;
...
let maskId = 0;
// Separate variable needed for closure.
const radioBaseClass = mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(mixinFocusable(lit_element_i))));
/**
 * A radio component.
 *
...
// Separate variable needed for closure.
const selectBaseClass = mixinDelegatesAria(mixinOnReportValidity(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(lit_element_i)))));
/**
 * @fires change {Event} The native `change` event on
 * [`<input>`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/change_event)
 * --bubbles
...
class FilledSelect extends Select {
    constructor() {
        super(...arguments);
        this.fieldTag = static_i `md-filled-field`;
    }
}
...
class OutlinedSelect extends Select {
    constructor() {
        super(...arguments);
        this.fieldTag = static_i `md-outlined-field`;
    }
}
...
// Separate variable needed for closure.
const selectOptionBaseClass = mixinDelegatesAria(lit_element_i);
/**
 * @fires close-menu {CustomEvent<{initiator: SelectOption, reason: Reason, itemPath: SelectOption[]}>}
 * Closes the encapsulating menu on closable interaction. --bubbles --composed
...
// Separate variable needed for closure.
const sliderBaseClass = mixinDelegatesAria(mixinFormAssociated(mixinElementInternals(lit_element_i)));
/**
 * Slider component.
 *
 *
...
// Separate variable needed for closure.
const switchBaseClass = mixinDelegatesAria(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(lit_element_i))));
/**
...
// Separate variable needed for closure.
const tabBaseClass = mixinFocusable(lit_element_i);
/**
 * Tab component.
 */
 ...
 *
 */
class Tabs extends lit_element_i {
    /**
...
// Separate variable needed for closure.
const textFieldBaseClass = mixinDelegatesAria(mixinOnReportValidity(mixinConstraintValidation(mixinFormAssociated(mixinElementInternals(lit_element_i)))));
/**
...
const textfield_internal_shared_styles_styles = i `:host{display:inline-flex;outline:none;resize:both;text-align:start;-webkit-tap-highlight-color:rgba(0,0,0,0)}.text-field,.field{width:100%}.text-field{display:inline-flex}.field{cursor:text}.disabled .field{cursor:default}.text-field,.textarea .field{resize:inherit}slot[name=container]{border-radius:inherit}.icon{color:currentColor;display:flex;align-items:center;justify-content:center;fill:currentColor;position:relative}.icon ::slotted(*){display:flex;position:absolute}[has-start] .icon.leading{font-size:var(--_leading-icon-size);height:var(--_leading-icon-size);width:var(--_leading-icon-size)}[has-end] .icon.trailing{font-size:var(--_trailing-icon-size);height:var(--_trailing-icon-size);width:var(--_trailing-icon-size)}.input-wrapper{display:flex}.input-wrapper>*{all:inherit;padding:0}.input{caret-color:var(--_caret-color);overflow-x:hidden;text-align:inherit}.input::placeholder{color:currentColor;opacity:1}.input::-webkit-calendar-picker-indicator{display:none}.input::-webkit-search-decoration,.input::-webkit-search-cancel-button{display:none}@media(forced-colors: active){.input{background:none}}.no-spinner .input::-webkit-inner-spin-button,.no-spinner .input::-webkit-outer-spin-button{display:none}.no-spinner .input[type=number]{-moz-appearance:textfield}:focus-within .input{caret-color:var(--_focus-caret-color)}.error:focus-within .input{caret-color:var(--_error-focus-caret-color)}.text-field:not(.disabled) .prefix{color:var(--_input-text-prefix-color)}.text-field:not(.disabled) .suffix{color:var(--_input-text-suffix-color)}.text-field:not(.disabled) .input::placeholder{color:var(--_input-text-placeholder-color)}.prefix,.suffix{text-wrap:nowrap;width:min-content}.prefix{padding-inline-end:var(--_input-text-prefix-trailing-space)}.suffix{padding-inline-start:var(--_input-text-suffix-leading-space)}
`;
//# sourceMappingURL=shared-styles.js.map
